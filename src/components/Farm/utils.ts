...
//   // const farm0MasterChefAddress = GAMMA_MASTERCHEF_ADDRESSES[ChainId.INK].toLowerCase()
//   // const farm1MasterChefAddress = GAMMA_MASTERCHEF_ADDRESSES[ChainId.INK].toLowerCase()
