...
import { Currency, CurrencyAmount, Percent } from '@jingofi/sdk-core'
import { FeeAmount, NonfungiblePositionManager } from '@jingofi/v3-sdk'
...
export default function AddLiquidity() {
  ...
  // prevent an error if they input XPL/WETH
  const quoteCurrency =
