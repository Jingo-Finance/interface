  ...
  describe('updateVersion', () => {
    describe('never initialized', () => {
      beforeEach(() => {
        store = createStore(reducer, {
          byUrl: {
            'https://unpkg.com/@pollum-io/default-token-list@latest/plasma-default.tokenlist.json': {
              error: null,
              current: STUB_TOKEN_LIST,
              loadingRequestId: null,
              pendingUpdate: null,
      ...
      it('clears the current lists', () => {
        expect(
          store.getState().byUrl['https://unpkg.com/@pollum-io/default-token-list@latest/plasma-default.tokenlist.json']
        ).toBeUndefined()
    ...
    describe('initialized with a different set of lists', () => {
      ...
      it('each of those initialized lists is empty', () => {
        ...
        Object.entries(byUrl)
          ...
          .filter(
            ([url]) => url !== 'https://unpkg.com/@pollum-io/default-token-list@latest/plasma-default.tokenlist.json'
          )
          .forEach(([, state]) => {
