...
export function useMasterChefContract(withSignerIfPossible?: boolean, abi?: any) {
  return useContract(GAMMA_MASTERCHEF_ADDRESSES[ChainId.INK], abi ?? GammaMasterChef, withSignerIfPossible)
}
...
export function useGammaUniProxyContract(withSignerIfPossible?: boolean) {
  return useContract(GAMMA_UNIPROXY_ADDRESSES[ChainId.INK], GammaUniProxyABI, withSignerIfPossible)
}
