import { Currency, CurrencyAmount, Price, Token, TradeType } from '@jingofi/sdk-core'
...
import { USDC_PLASMA } from '../constants/tokens'
...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.PLASMA]: CurrencyAmount.fromRawAmount(USDC_PLASMA, 10_000e6),
