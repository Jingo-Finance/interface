...
export const COMMON_CONTRACT_NAMES: Record<number, { [address: string]: string }> = {
  ...
  //   [UNI_ADDRESS[SupportedChainId.INK]]: 'PSYS',
  //   [TIMELOCK_ADDRESS[SupportedChainId.INK]]: 'Timelock',
  //   [GOVERNANCE_ALPHA_V0_ADDRESSES[SupportedChainId.INK]]: 'Governance (V0)',
  //   [GOVERNANCE_ALPHA_V1_ADDRESSES[SupportedChainId.INK]]: 'Governance (V1)',
  //   [GOVERNANCE_BRAVO_ADDRESSES[SupportedChainId.INK]]: 'Governance',
